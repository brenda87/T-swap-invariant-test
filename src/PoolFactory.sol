...
contract PoolFactory {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    mapping(address token => address pool) private s_pools; // e poolToken => pool address e.g usdc => pool address
    mapping(address pool => address token) private s_tokens; // e pool address => poolToken 
    ...
    function createPool(address tokenAddress) external returns (address) {
        ...
        //e could be like e.g T-Swap DAI
